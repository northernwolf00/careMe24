      ...
      child: Scaffold(
                      ...
                      child: Column(
                          ...
                          children: [
                            AppbarSubtitle2(
                                text: widget.specialization,
                                margin: getMargin(right: 30)),
                            AppbarSubtitle2(text: widget.name),
                            Padding(
                                padding: getPadding(top: 1, right: 67),
                                child: Row(children: [
                                  const AppbarSubtitle2(text: ""),
                                  Container(
                                      height: getSize(8),
                                      width: getSize(8),
                                      margin: getMargin(left: 5, top: 3, bottom: 3),
                                      decoration: BoxDecoration(
                                          borderRadius: BorderRadius.circular(
                                              getHorizontalSize(4)),
                                          border: Border.all(
        ...
        body: Container(
            ...
            child: Column(
                ...
                children: [
                  ...
                  //       DateTime dateTime = DateTime.parse(message.createdAt.toString());
                  //       String formattedDate = DateFormat('yyyy-MM-dd').format(dateTime);
                  //       String formattedTime = DateFormat('hh:mm a').format(dateTime);
        ...
        bottomNavigationBar: Padding(
          ...
          child: Row(
            children: [
              IconButton(
                icon: Icon(Icons.attach_file, color: Colors.grey), // Disabled look
                onPressed: null, // Disable file attachment
              ),
              Expanded(
                child: CustomTextFormField(
                  controller: messageController,
